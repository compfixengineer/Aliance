...
<body>
    ...
    <header class="header header-page header-page-bg-grey header-page-image-bg">
        <div class="container">
            <div class="header-content-page">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="breadcrumbs-item active">
                      <a href="./blog.php" class="breadcrumbs-link">Современная методология разработки одухотворила всех причастных</a>
                    </li>
                  </ul>
            </div>
            <!-- /.header-content -->
