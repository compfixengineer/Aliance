<div class="container">
    ...
    <div class="swiper features-slider">
        ...
        <ul class="swiper-wrapper header-features about-page-header-features">
        <!-- Слайды -->
        ...
        <!-- Кнопки навигации -->
        <div class="slider-buttons about-page-slider-buttons">
            <div class="slider-button-prev">
                <svg width="36" height="24" fill="#292D33">
