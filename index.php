...
<body class="front-page">
    <div class="mobile-menu">
        <ul class="mobile-menu-nav">
            <li class="mobile-menu-nav-item">
                <a href="./about.php" class="mobile-menu-link" aria-label="О компании">О компании</a>
            </li>
            <li class="mobile-menu-nav-item">
                <a href="./contract-trades.php" class="mobile-menu-link" aria-label="Контрактное производство">Контрактное производство</a>
                <ul class="mobile-submenu">
                    <li class="mobile-submenu-item">
                        <a href="./autochemistry.php" class="mobile-submenu-link" aria-label="Автомобильная химия">Автомобильная химия</a>
                    </li>
                    <li class="mobile-submenu-item">
                        <a href="#" class="mobile-submenu-link" aria-label="Автомобильная химия">Бытовая химия</a>
                    </li>
                    <li class="mobile-submenu-item">
                        <a href="#" class="mobile-submenu-link" aria-label="Дезенфицирующие средства">Дезенфицирующие средства</a>
                    </li>
                    <li class="mobile-submenu-item">
                        <a href="#" class="mobile-submenu-link" aria-label="Пищевые аэрозоли">Пищевые аэрозоли</a>
                    </li>
                    <li class="mobile-submenu-item">
                        <a href="#" class="mobile-submenu-link" aria-label="Косметическая продукция">Косметическая продукция</a>
                    </li>
                    <li class="mobile-submenu-item">
                        <a href="#" class="mobile-submenu-link" aria-label="Краски аэрозольные">Краски аэрозольные</a>
                    </li>
                </ul>
            </li>
            <li class="mobile-menu-nav-item">
                <a href="#" class="mobile-menu-link" aria-label="Собственные марки">Собственные марки</a>
                <ul class="mobile-submenu">
                    <li class="mobile-submenu-item">
                        <a href="#" class="mobile-submenu-link" aria-label="Автохимия AG-Tech">Автохимия AG-Tech</a>
                    </li>
                    <li class="mobile-submenu-item">
                        <a href="#" class="mobile-submenu-link" aria-label="Автохимия AP">Автохимия AP</a>
                    </li>
                </ul>   
            </li>
            <li class="mobile-menu-nav-item">
                <a href="#" class="mobile-menu-link" aria-label="Новости">Новости</a>
            </li>
            <li class="mobile-menu-nav-item">
                <a href="#" class="mobile-menu-link" aria-label="Контакты">Контакты</a>
            </li>
        </ul>
        <a href="tel:+74996861014" class="mobile-phone" aria-label="+7(499) 686-10-14">+7(499) 686-10-14</a>
        ...
        <div class="mobile-info">
            ...
            <a href="mailto:a.dragunov@tdaliance.ru" class="mobile-info-email" aria-label="a.dragunov@tdaliance.ru">
                a.dragunov@tdaliance.ru</a>
        </div>
        
        <a href="#" class="sotial-media-vk" aria-label="vk">
            <svg class="vkontakte-icon" width="24" height="24"  >
                <use href="img/sprite.svg#vkontakte"></use>
            </svg>
        </a>

        <a href="#" class="sotial-media-inst" aria-label="inst">
    ...
    <nav class="navbar">
            ...
            <a href="./" class="header-logo" aria-label="Главная страница"> <!--./ перевод по нажатию на логотип на главную страницу -->
